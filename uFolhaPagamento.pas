...
begin
  ...
  if cdsFolhaPagamento.FindKey([edCodigo.Text]) then
     begin
       cdsFuncionario.IndexFieldNames := 'bdCODIGOFUNCIONARIO';
       cdsFuncionario.FindKey([cdsFolhaPagamentobdCODIGOFUNCIONARIO.AsInteger]);
...
begin
  ...
  while not cdsFolhaPagamento.Eof do
    begin
      if (cdsFolhaPagamentobdCODIGOFUNCIONARIO.AsInteger = cdsFuncionariobdCODIGOFUNCIONARIO.AsInteger) and (cdsFolhaPagamentobdMES.AsString = cbMes.Text) and (cdsFolhaPagamentobdANO.AsString = edAno.Text) then
         begin
           Result := True;
           Exit;
         end;
